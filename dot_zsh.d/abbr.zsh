...
abbr --session --quiet ccl="brew upgrade claude-code@latest; claude --dangerously-skip-permissions"
abbr --session --quiet ccr="brew upgrade claude-code@latest; claude --dangerously-skip-permissions -r"
